...
var Manager = (function () {
    ...
    Manager.prototype.saveUser = function (u, callback) {
        this.db.collection(this.collection, function (err, coll) {
            if (err) {
                callback(err, null);
                return;
    ...
    Manager.prototype.deleteUser = function (u, callback) {
        this.db.collection(this.collection, function (err, coll) {
            if (err) {
                callback(err, null);
                return;
    ...
    //are
    Manager.prototype.existsUser = function (userid, callback) {
        this.db.collection(this.collection, function (err, coll) {
            if (err) {
                callback(err, null);
                return;
            }
            coll.findOne({ id: userid }, { id: 1 }, function (err, doc) {
